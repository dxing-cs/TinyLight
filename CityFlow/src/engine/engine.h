...
namespace CityFlow {
    ...
    private:
        ...
        double cumulativeTravelTimeSquare = 0;
        std::list<double> vehicleTravelTime;
    ...
    public:
        ...
        double getStdTravelTime() const;

        std::list<double> getVehicleTravelTime() const;

        int getFinishedVehicleCnt() const;
