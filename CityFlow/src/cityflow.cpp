...
PYBIND11_MODULE(cityflow, m) {
    py::class_<CityFlow::Engine>(m, "Engine")
        ...
        .def("get_std_travel_time", &CityFlow::Engine::getStdTravelTime)             // by TinyLight
        .def("get_vehicle_travel_time", &CityFlow::Engine::getVehicleTravelTime)     // by TinyLight
        .def("get_finished_vehicle_cnt", &CityFlow::Engine::getFinishedVehicleCnt)   // by TinyLight
